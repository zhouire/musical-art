...
def use():
    ...
    t = float(input("Length of each tone in seconds (number from " + str(0.05) + " to " + str(2500/(pixels_in_row*pixels_in_col)) + "): "))
        
    while t < 0.05 or t > 2500/(pixels_in_row*pixels_in_col):
        print("Must be between 0.5 and", 2500/(pixels_in_row*pixels_in_col), "; try again")
        t = float(input("Length of each tone in seconds (number from " + str(0.05) + " to " + str(2500/(pixels_in_row*pixels_in_col)) + "): "))
